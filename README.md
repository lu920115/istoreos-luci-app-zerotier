...
```bash
wget -O /tmp/luci-app-zerotier.ipk https://github.com/lu920115/istoreos-luci-app-zerotier/releases/download/v1.3.2-4/luci-app-zerotier_1.3.2-r3_all.ipk
opkg install /tmp/luci-app-zerotier.ipk
```

#### 安装 zerotier 后端（可选，按架构选择）

Release 中包含 zerotier 后端 1.16.0 编译包，适用于不同架构：

| 架构 | 适用设备 | 下载命令 |
|------|---------|---------|
| **x86_64** | x86 软路由、小主机 | `wget https://github.com/lu920115/istoreos-luci-app-zerotier/releases/download/v1.3.2-4/zerotier_1.16.0-r2_x86_64.ipk` |
| **aarch64_cortex-a53** | mediatek-filogic 设备（MT7981/7986 等） | `wget https://github.com/lu920115/istoreos-luci-app-zerotier/releases/download/v1.3.2-4/zerotier_1.16.0-r2_aarch64_cortex-a53.ipk` |
| **aarch64_generic** | rockchip-armv8 设备（RK3399/RK3568 等） | `wget https://github.com/lu920115/istoreos-luci-app-zerotier/releases/download/v1.3.2-4/zerotier_1.16.0-r2_aarch64_generic.ipk` |
...
> 注意：LuCI 插件不含 zerotier 后端程序。如果系统没有 zerotier，安装后会自动提示你先去 iStore 商店安装 ZeroTier。你也可以使用上述 ipk 直接安装 1.16.0 版本。
